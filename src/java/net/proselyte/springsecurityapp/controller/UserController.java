...
/**
 * Conroller for {@link net.proselyte.springsecurityapp.model.User}'s pages.
 * @author Rotar Maxim
 * @version 1.0
 */
@Controller
public class UserController {
   ...
   public String registration(Model model){
    ...
    public  String registration (@ModelAttribute("userFrom")User userFrom , BindingResult bindingResult, Model model) {
